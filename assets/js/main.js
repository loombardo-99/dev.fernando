...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectDetails = {
        ...
        'proj4': {
            ...
            images: ['assets/img/quiz1.png',
                'assets/img/quiz2.png',
                'assets/img/quiz3.png',
                'assets/img/quiz4.png'
            ],
            description: '',
            overview: 'Ferramenta interativa para autoavaliação de Inteligência Emocional com versões Web e CLI.',
            problem: 'Necessidade de uma ferramenta acessível para indivíduos identificarem pontos fortes e áreas de melhoria no gerenciamento de emoções e habilidades sociais.',
            solution: 'Aplicação que aplica um questionário de 20 perguntas, calcula a pontuação automaticamente e fornece feedback personalizado imediato.',
            features: [
                'Avaliação Interativa (20 perguntas)',
                'Feedback Imediato Detalhado',
                'Versão Web Responsiva e CLI (Python)',
        ...
        'proj5': {
            title: 'Agentes do Dia',
            number: '05',
            tags: ['Gemini API', 'Tailwind', 'JS Vanilla'],
            images: ['assets/img/assistente1.png',
                'assets/img/assistente2.png',
                'assets/img/assistente3.png',
                'assets/img/assistente4.png',
                'assets/img/assistente5.png',
                'assets/img/assistente6.png',
                'assets/img/assistente7.png'
            ],
            description: '',
            overview: 'Plataforma web com consultores virtuais especializados (Bíblico, Saúde, Financeiro, Estudos) via chat AI.',
            problem: 'Dificuldade e demora em encontrar orientação personalizada e confiável para dúvidas do dia a dia (saúde, fé, finanças).',
            solution: 'Centraliza o acesso a agentes especializados treinados com Google Gemini para fornecer orientação contextual e amigável em tempo real.',
            features: [
                'Quiz de Seleção Inteligente de Agente',
                'Agentes Especializados (Bíblico, Saúde, Finanças, Estudos)',
        ...
        'proj6': {
            title: 'Terra Forte',
            number: '06',
            tags: ['PHP', 'IoT', 'MySQL', 'Dashboard'],
            images: ['assets/img/terra1.png',
                'assets/img/terra2.png',
                'assets/img/terra3.png',
                'assets/img/terra4.png',
                'assets/img/terra5.png',
                'assets/img/terra6.png',
                'assets/img/terra7.png',
                'assets/img/terra8.png',
                'assets/img/terra9.png',
                'assets/img/terra10.png',
                'assets/img/terra11.png',
                'assets/img/terra12.png',
                'assets/img/terra13.png',
                'assets/img/terra14.png',
                'assets/img/terra15.png',
                'assets/img/terra16.png',
                'assets/img/terra17.png',
                'assets/img/terra18.png',
                'assets/img/terra19.png',
                'assets/img/terra20.png',
                'assets/img/terra21.png',
                'assets/img/terra22.png'

            ],
            description: '',
            overview: 'Sistema de gestão (ERP) focado no agronegócio que integra monitoramento IoT e gestão administrativa.',
            problem: 'Falta de visibilidade em tempo real das condições climáticas, dificuldade no controle de tarefas e fragmentação de informações vitais.',
            solution: 'Centraliza dados de sensores, status de tarefas e alertas em um Dashboard Interativo para gestão inteligente baseada em dados.',
            features: [
                'Painel de Controle Unificado com KPIs',
                'Monitoramento Climático Real-Time (IoT)',
                'Gestão de Tarefas Completa (Kanban/Lista)',
